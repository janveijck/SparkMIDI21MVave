...
case 11:  /*   Dire Straits - M-Vave position:  13  */  
						...
						change_amp_param(0,0.7428226470947266);
						change_amp_param(1,0.5703526139259338);
						change_amp_param(2,0.37456339597702026);
						change_amp_param(3,0.34118592739105225);
						change_amp_param(4,1);
						change_mod_model("Flanger");change_mod_onoff(true);
						change_mod_param(0,0.4839097559452057);
						change_mod_param(1,0.4942026734352112);
						change_mod_param(2,0.6851881146430969);
						change_delay_model("VintageDelay");change_delay_onoff(true);
						change_delay_param(0,0.6639750003814697);
						change_delay_param(1,0.1889059990644455);
						change_delay_param(2,0.34498900175094604);
...
case 12:  /*  Bend the Fend - M-Vave position:  14  */  
						...
						change_mod_param(0,0.24334999918937683);
						change_mod_param(1,0);
						change_mod_param(2,0.699999988079071);
						change_mod_param(3,0.5949220061302185);
...
case 14:  /*  Hendrix  - M-Vave position:  16  */  
						...
						change_mod_model("ChorusAnalog");change_mod_onoff(true);
						change_mod_param(0,0.1695600003004074);
...
case 16:  /*  Eddie Van Halen - M-Vave position:  18  */  
						...
						change_mod_model("ChorusAnalog");change_mod_onoff(true);
						change_mod_param(0,0.3062500059604645);
						change_mod_param(1,0.10625000298023224);
						change_mod_param(2,0.6520829796791077);
						change_mod_param(3,1);
						change_delay_model("DelayMono");change_delay_onoff(true);
...
case 17:  /*  SRV - M-Vave position:  19  */  
						...
						change_mod_model("Phaser");change_mod_onoff(false);
						change_mod_param(0,0.33645832538604736);
						change_mod_param(1,0.6095833778381348);
						change_mod_param(2,0);
						change_mod_param(3,0);
...
case 19:  /*  Nothing else matters - M-Vave position:  21  */  
						...
						change_mod_model("Flanger");change_mod_onoff(true);
						change_mod_param(0,0.41379307981195124);
						change_mod_param(1,0.6630434756693633);
						change_mod_param(2,0.6551724364017618);
						change_delay_model("DelayMono");change_delay_onoff(true);
...
case 21:  /*   Purple Rain - M-Vave position:  23  */  
						...
						change_mod_model("ChorusAnalog");change_mod_onoff(true);
						change_mod_param(0,0.4200482964515686);
						change_mod_param(1,0.18392600119113922);
						change_mod_param(2,0.9247268457566538);
						change_mod_param(3,0.876171886920929);
						change_delay_model("DelayRe201");change_delay_onoff(true);
...
case 22:  /*  John mayer ish - M-Vave position:  24  */  
						...
						change_amp_param(4,0.5799999833106995);
						change_mod_model("Tremolo");change_mod_onoff(true);
						change_mod_param(0,0.25416800379753113);
						change_mod_param(1,0.2634420096874237);
						change_mod_param(2,0.6000000238418579);
						change_delay_model("DelayMono");change_delay_onoff(true);
						change_delay_param(0,0.064021997153759);
						change_delay_param(1,0.21516799926757812);
						change_delay_param(2,0.6917970180511475);
...
case 23:  /*  Shine On Crazy Diamond Clean - M-Vave position:  25  */  
						...
						change_amp_param(4,0.5799999833106995);
						change_mod_model("Flanger");change_mod_onoff(true);
						change_mod_param(0,0.11428199708461761);
						change_mod_param(1,0.5917969942092896);
						change_mod_param(2,0.2982200086116791);
						change_delay_model("DelayMono");change_delay_onoff(false);
						change_delay_param(0,0.38177722692489624);
						change_delay_param(1,0.39830508828163147);
						change_delay_param(2,0.7363313436508179);
...
case 25:  /*  Clean Rhythm Delay - M-Vave position:  27  */  
						...
						change_mod_model("ChorusAnalog");change_mod_onoff(true);
						change_mod_param(0,0.16949009895324707);
						change_mod_param(1,0.5677965879440308);
						change_mod_param(2,0.21610170602798462);
						change_mod_param(3,0.25);
						change_delay_model("DelayRe201");change_delay_onoff(true);
...
case 27:  /*  Modern Vintage Clean - M-Vave position:  29  */  
						...
						change_amp_param(4,0.68);
						change_mod_model("ChorusAnalog");change_mod_onoff(true);
						change_mod_param(0,0.38109778080667767);
						change_mod_param(1,0.3716855396522335);
						change_mod_param(2,0.5801185340237764);
						change_mod_param(3,0.817796528339386);
						change_delay_model("DelayRe201");change_delay_onoff(false);
						change_delay_param(0,0.26535865664482117);
						change_delay_param(1,0.37925663590431213);
						change_delay_param(2,0.29451701045036316);
...
case 28:  /*  Pink Floyd - Comfortably Numb (solo 2) - M-Vave position:  30  */  
						...
						change_mod_model("Flanger");change_mod_onoff(true);
						change_mod_param(0,0.2503640055656433);
						change_mod_param(1,0.1801069974899292);
						change_mod_param(2,0.1530420035123825);
						change_delay_model("DelayRe201");change_delay_onoff(true);
...
case 29:  /*  SRV Clean - M-Vave position:  31  */  
						...
						change_amp_param(4,0.5799999833106995);
						change_mod_model("Tremolo");change_mod_onoff(true);
						change_mod_param(0,0.10586799681186676);
						change_mod_param(1,0.20565199851989746);
						change_mod_param(2,0.34139400720596313);
						change_delay_model("DelayMono");change_delay_onoff(true);
...
case 30:  /*  OLD VH - M-Vave position:  32  */  
						...
						change_amp_param(4,0.699999988079071);
						change_mod_model("Flanger");change_mod_onoff(true);
						change_mod_param(0,0.20208300650119781);
						change_mod_param(1,0.58576500415802);
						change_mod_param(2,0.1690869927406311);
						change_delay_model("DelayMono");change_delay_onoff(false);
						change_delay_param(0,0.38177722692489624);
						change_delay_param(1,0.39830508828163147);
						change_delay_param(2,0.7363313436508179);
...
case 33:  /*   Clean for Ballads - M-Vave position:  35  */  
						...
						change_amp_param(4,1);
						change_mod_model("Flanger");change_mod_onoff(true);
						change_mod_param(0,0.353);
						change_mod_param(1,0.6017);
						change_mod_param(2,0.9009);
						change_delay_model("VintageDelay");change_delay_onoff(true);
...
case 34:  /*  12 str acou strumming.CN1 - M-Vave position:  36  */  
						...
						change_mod_model("ChorusAnalog");change_mod_onoff(true);
						change_mod_param(0,0.5038949847221375);
						change_mod_param(1,0.20000000298023224);
						change_mod_param(2,0.699999988079071);
						change_mod_param(3,1);
						change_delay_model("DelayRe201");change_delay_onoff(true);
